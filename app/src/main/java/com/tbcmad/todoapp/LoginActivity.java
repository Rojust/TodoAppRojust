    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userName.getText().toString().equals("Rojust") && password.getText().toString().equals("Rojust")) {
                ...
                else if(!userName.getText().toString().equals("Rojust") && password.getText().toString().equals("Rojust"))
                {
